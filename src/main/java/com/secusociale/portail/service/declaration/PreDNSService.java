...
public class PreDNSService {
    ...
    List<CmPresDns.InformationSalaries> listSalaries = new ArrayList<CmPresDns.InformationSalaries>();
      ...
      //  listSalaries = cmPreDns.value.getInformationSalaries();
         ...
         DeclarationModel declarationModel = new DeclarationModel();
          ...
          /*   for (int i=0 ; i < listSalaries.size() ; i++) {
                 ...
                 DeclarationModel.EmployeModel employeModel = declarationModel.new EmployeModel() ;
                 ...
                 employeModel.setDateNaissance(listSalaries.get(i).getDateNaissance().getValue().toGregorianCalendar().getTime());
