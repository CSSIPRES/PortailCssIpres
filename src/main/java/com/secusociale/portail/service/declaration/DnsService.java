...
import com.secusociale.portail.service.soap.declaration.DNSINBOUNDSERVICE;
...
import com.secusociale.portail.service.soap.declaration.DNSINBOUNDSERVICEPortType;
import com.secusociale.portail.service.soap.declaration.DNSINBOUNDSERVICEService;
import com.secusociale.portail.service.soap.declaration.ObjectFactory;
...
public class DnsService {
	...
	public Holder<DeclarationModel> createDns (DeclarationModel dnsInput) throws  DatatypeConfigurationException, ParseException, JAXBException, com.google.protobuf.TextFormat.ParseException{
		...
		//SimpleDateFormat formatDate = new SimpleDateFormat("yyyy-MM-dd");
		 ...
		 gDateDebutCalendar.setTime(dnsInput.getDateDebutCotisation());
