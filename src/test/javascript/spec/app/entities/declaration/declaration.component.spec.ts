...
import { DeclarationComponent } from 'app/entities/declaration/declaration.component';
...
describe('Component Tests', () => {
  describe('Declaration Management Component', () => {
    let comp: DeclarationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DeclarationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.declarations && comp.declarations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
