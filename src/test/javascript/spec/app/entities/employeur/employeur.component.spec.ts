...
import { EmployeurComponent } from 'app/entities/employeur/employeur.component';
...
describe('Component Tests', () => {
  describe('Employeur Management Component', () => {
    let comp: EmployeurComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmployeurComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.employeurs && comp.employeurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
